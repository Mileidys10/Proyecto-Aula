    ...
    <main class="contenedor">
        <section class="tarjeta-detalle-producto">
            <figure class="contenedor-imagen">
                <img src="../../img/toures/daytour.jpg" alt="Day Tour" style="width: 100%; border-radius: 15px;">
            </figure>

            <div class="informacion-producto">
                <h2 class="titulo-secundario">Day Tour</h2><br>
                <p class="descripcion">
                    Sumérgete en un día de sol, mar y música con nuestro plan Day Tour. Perfecto para grupos de amigos que desean disfrutar de las playas y la vida marina.
                    <ul class="lista-detalle">
                        <li>Tour a playas privadas o islas cercanas</li>
                        <li>Parlante, hielera y bebidas incluidas</li>
                        <li>Hasta 15 personas por embarcación</li>
                        <li>Horario: 9:00 a.m. – 4:00 p.m.</li>
                    </ul>
                </p><br>
                <p class="precio">
                    <strong>Precio:</strong> $1.800.000 COP
                </p>

                <button class="agregar-carrito boton-principal" data-nombre="Day Tour" data-precio="1800000">
