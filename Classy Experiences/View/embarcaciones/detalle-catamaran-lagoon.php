...
<head>
    ...
    <title>Catamarán Lagoon 52 FT</title>
    ...
    <main class="contenedor">
        <section class="tarjeta-detalle-producto">
            ...
            <div class="informacion-producto">
                <h2 class="titulo-secundario">Catamarán Lagoon 52 FT</h2><br>
                <p class="descripcion">
                    Navega con estilo y comodidad en el Catamarán Lagoon 52 FT, una embarcación de lujo ideal para explorar las aguas del Caribe.
                    Con amplios espacios y elegantes acabados, este catamarán ofrece una experiencia exclusiva para relajarse y disfrutar del mar.
                </p>
                <br>
                <p class="precio">
